  ...
  <section id="about" class="about_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          Hello, I am Vireak. I work for the Ministry of Inspection, The Ministry has sent me to attend software development course. 
          This course made me aware of important new experiences in website programming.
        </p>
      </div>
      <div class="row">
        <div class="col-md-6">
